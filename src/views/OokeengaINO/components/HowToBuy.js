  ...
  return (
    <div style={{ color: '#F5E6D5', fontSize: '18px' }}>
      ...
      <div className='mb-4'>
        ...
        another transaction for the unpaid amount and inform us via support@ookeenga.io to secure your items. In
      ...
      <div className='mb-4'>
        ...
        Please refer to them or contact us via support@ookeenga.io.
      </div>
    </div>
  );
};
